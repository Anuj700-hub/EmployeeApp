package com.example.logcatviewer.standout;
...
public abstract class StandOutWindow extends Service {
	 ...
	 */
	public Notification getPersistentNotification(int id, String channelId) {
	...
	public final synchronized Window show(int id) {
		...
		try {
			...
			Log.e("log_exception", "Exception: " + ex.getMessage());
		}
		...
		if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
			channelId = createNotificationChannel("Log Service", "Hungerbox Cafe Logs");
		}

		notification = getPersistentNotification(id, channelId);
...
//					notification);
	...
	public class StandOutLayoutParams extends WindowManager.LayoutParams {
		...
		public StandOutLayoutParams(int id) {
			super(200, 200, (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) ? TYPE_APPLICATION_OVERLAY: TYPE_PHONE,
