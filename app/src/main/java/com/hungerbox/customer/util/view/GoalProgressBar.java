...
public class GoalProgressBar extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        try {
            ...
            setGoalReachedColor(typedArray.getColor(R.styleable.GoalProgressBar_goalReachedColor, getResources().getColor(R.color.colorPrimary)));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int progressEndX = (int) (getWidth() * value);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            canvas.drawRoundRect(progressEndX, halfHeight, getWidth(), halfHeight, 10, 10, progressPaint);

        } else {
            canvas.drawRect(progressEndX, halfHeight, getWidth(), halfHeight, progressPaint);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            canvas.drawRoundRect(15
                    , halfHeight, progressEndX, halfHeight, 10, 10, progressPaint);
        } else {
            canvas.drawRect(10, halfHeight, progressEndX, halfHeight, progressPaint);
