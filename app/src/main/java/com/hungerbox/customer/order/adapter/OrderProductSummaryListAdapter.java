...
public class OrderProductSummaryListAdapter extends RecyclerView.Adapter<OrderProductItemViewHolder> {
    ...
    public OrderProductSummaryListAdapter(Activity activity, List<OrderProduct> products) {
    ...
    public OrderProductItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new OrderProductItemViewHolder(inflater.inflate(R.layout.order_product_item, parent, false));
    }
