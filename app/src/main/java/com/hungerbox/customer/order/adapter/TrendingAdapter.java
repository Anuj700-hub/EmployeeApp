...
public class TrendingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TrendingAdapter(AppCompatActivity activity, List<Object> products, Vendor vendor, VendorValidationListener vendorValidationListener, long occasionId,VegNonVegSwitchListener vegNonSwitchListener) {
    ...
    public TrendingAdapter(AppCompatActivity activity, List<Object> products, List<Vendor> vendors,
    ...
    public TrendingAdapter(AppCompatActivity activity, List<Object> products, Vendor vendor,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == viewTypeHeader){
            ...
            //for products
                ProductItemViewHolder holder = new ProductItemViewHolder(inflater.inflate(R.layout.trending_list_item, parent, false));
                return holder;
        }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder mHolder, final int position) {
        ...
        if(activity != null){
            if(activity instanceof BookmarkPaymentActivity){
                tagForApiRequest = ((BookmarkPaymentActivity) activity).getApiTag();
            }
        }
