 ...
 * {@link FreeOrderErrorHandleDialog.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FreeOrderErrorHandleDialog#newInstance} factory method to
...
public class FreeOrderErrorHandleDialog extends DialogFragment {
    ...
    public FreeOrderErrorHandleDialog() {
    ...
    public static FreeOrderErrorHandleDialog newInstance(Order order,
                                                         String error, OnFragmentInteractionListener listener) {
        FreeOrderErrorHandleDialog fragment = new FreeOrderErrorHandleDialog();
    ...
    public static FreeOrderErrorHandleDialog newInstance(Order order, String error, OnFragmentInteractionListener listener, String positiveButtonText) {
        FreeOrderErrorHandleDialog fragment = new FreeOrderErrorHandleDialog();
        fragment.order = order;
        fragment.errorMessage = error;
        fragment.mListener = listener;
    ...
    public static FreeOrderErrorHandleDialog newInstance(Order order, String error, OnFragmentInteractionListener listener,
                                                         String positiveButtonText, String negativeButtonText) {
        FreeOrderErrorHandleDialog fragment = newInstance(order, error, listener, positiveButtonText);
