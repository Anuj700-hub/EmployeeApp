...
public class VendorOffline implements Serializable {
    ...
    public VendorOffline setId(long id) {
        this.id = id;
        return this;
    }
    ...
    public VendorOffline setVendorName(String vendorName) {
    ...
    public VendorOffline setCuisines(ArrayList<String> cuisines) {
    ...
    public VendorOffline setAvgOrderTime(long avgOrderTime) {
    ...
    public VendorOffline setBuffetAvailable(int buffetAvailable) {
    ...
    public VendorOffline setBuffetPrice(double buffetPrice) {
    ...
    public VendorOffline setAvailable(boolean available) {
    ...
    public void setMenu(ProductResponseOffline menu) {
        this.menu = menu;
    }
