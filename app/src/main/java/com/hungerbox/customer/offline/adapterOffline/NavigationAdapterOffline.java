...
import com.hungerbox.customer.offline.activityOffline.HistoryActivityOffline;
 ...
 */
public class NavigationAdapterOffline extends RecyclerView.Adapter<NavigationDrawerItemViwHolder> {
    ...
    public NavigationAdapterOffline(Activity activty, DrawerOpenCloseListener drawerOpenCloseListener) {
    ...
    private void populateNaviagtionDrawer() {
        ...
        NavigationItem nav = new NavigationItem().setId(0)
                .setKey("History")
                .setText("History")
    ...
    private void navigateTo(NavigationItem navigationItem) {
        ...
        switch (navigationItem.getKey()) {
            ...
            case ApplicationConstants.HISTORY:
                addEvent(EventUtil.NAV_SETTINGS);
                intent = new Intent(activity, HistoryActivityOffline.class);
                break;
            ...
            case ApplicationConstants.CAMPAIGN:
                ...
                intent.putExtra(CleverTapEvent.PropertiesNames.getSource(),"Nav");
//                intent = new Intent(activity, ContestDetailActivity.class);
                break;
            ...
            case ApplicationConstants.SIMPL:
                intent = new Intent(activity, SimplOtpVerificationActivity.class);
                intent.putExtra("fromNavBar", true);
                break;
